...
(doom-modeline-def-modeline 'main
  ...
  '(compilation objed-state misc-info time persp-name battery grip irc mu4e gnus github debug repl lsp minor-modes input-method indent-info buffer-encoding process vcs checker major-mode))
...
(doom-modeline-def-modeline 'special
  ...
  '(compilation objed-state misc-info time battery irc-buffers debug minor-modes input-method indent-info buffer-encoding process major-mode))
...
(doom-modeline-def-modeline 'vcs
  ...
  '(compilation misc-info time battery irc mu4e gnus github debug minor-modes buffer-encoding process major-mode))

(doom-modeline-def-modeline 'package
  '(bar window-number package)
  '(compilation misc-info time process major-mode))

(doom-modeline-def-modeline 'info
  '(bar window-number buffer-info info-nodes buffer-position parrot selection-info)
  '(compilation misc-info time buffer-encoding major-mode))

(doom-modeline-def-modeline 'media
  '(bar window-number buffer-size buffer-info)
  '(compilation misc-info time media-info process vcs major-mode))

(doom-modeline-def-modeline 'message
  '(bar window-number modals matches buffer-info-simple buffer-position word-count parrot selection-info)
  '(compilation objed-state misc-info time battery debug minor-modes input-method indent-info buffer-encoding major-mode))

(doom-modeline-def-modeline 'pdf
  '(bar window-number matches buffer-info pdf-pages)
  '(compilation misc-info time process vcs major-mode))

(doom-modeline-def-modeline 'org-src
  '(bar window-number modals matches buffer-info buffer-position word-count parrot selection-info)
  '(compilation objed-state misc-info time debug lsp minor-modes input-method indent-info buffer-encoding process checker major-mode))
