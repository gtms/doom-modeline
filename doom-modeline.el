...
(doom-modeline-def-modeline 'main
  ...
  '(compilation objed-state misc-info persp-name battery grip irc mu4e gnus github debug repl lsp minor-modes input-method indent-info buffer-encoding process vcs checker time major-mode))
...
(doom-modeline-def-modeline 'org-src
  ...
  '(compilation objed-state misc-info debug lsp minor-modes input-method indent-info buffer-encoding process checker time major-mode))
...
(doom-modeline-def-modeline 'timemachine
  ...
  '(misc-info minor-modes indent-info buffer-encoding time major-mode))
